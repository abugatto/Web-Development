...
#HELP:
#  remove fsevents in node_modules
#  use: npm install -D babel-loader @babel/core @babel/preset-env @babel/preset-react
#  make .babelrc with "@babel/presets-core" and "@babel/presets-react"
